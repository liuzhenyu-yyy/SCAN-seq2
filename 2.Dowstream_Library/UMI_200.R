...
sample.info[!sample.info$Barcode.3 %in% as.character(17:32),]$Cell_Line <- "K562"
sample.info[sample.info$Barcode.3 %in% as.character(17:32),]$Cell_Line <- "3T3"
...
ggplot()+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$UMI_200_Bc67_Bc01),color="Bc67_Bc01"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$UMI_200_Bc67_Bc02),color="Bc67_Bc02"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$UMI_200_Bc67_Bc03),color="Bc67_Bc03"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$UMI_200_Bc67_Bc04),color="Bc67_Bc04"))+
