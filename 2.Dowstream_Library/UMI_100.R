...
ggplot()+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$UMI_100_Bc75_Bc01),color="Bc75_Bc01"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$`UMI_100_Bc75_Bc02`),color="Bc75_Bc02"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$`UMI_100_Bc75_Bc03`),color="Bc75_Bc03"))+
  geom_point(aes(x=log10(1+ERCC.info$concentration_mix_1),
                 y=log10(1+rc_ERCC$`UMI_100_Bc75_Bc04`),color="Bc75_Bc04"))+
