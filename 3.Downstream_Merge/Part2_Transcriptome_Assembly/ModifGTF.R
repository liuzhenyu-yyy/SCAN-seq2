...
IGH.gtf[grep("IGHM|IGHA|IGHG|IGHE", IGH.gtf$symbols), ]$Type <-
  "Constant"
...
IGH.gtf$V9 <-
  paste0(IGH.gtf$V9, " type ", IGH.gtf$Type, "; color ", IGH.gtf$Color, ";")
...
IGL.gtf$V9 <-
  paste0(IGL.gtf$V9, " type ", IGL.gtf$Type, "; color ", IGL.gtf$Color, ";")
...
IGK.gtf$V9 <-
  paste0(IGK.gtf$V9, " type ", IGK.gtf$Type, "; color ", IGK.gtf$Color, ";")
...
TRB.gtf$V9 <-
  paste0(TRB.gtf$V9, " type ", TRB.gtf$Type, "; color ", TRB.gtf$Color, ";")
...
TRA.gtf$V9 <-
  paste0(TRA.gtf$V9, " type ", TRA.gtf$Type, "; color ", TRA.gtf$Color, ";")
