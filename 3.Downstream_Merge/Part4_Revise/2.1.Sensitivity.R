...
sample.info.merge <- rbind(sample.info.100,
                           ...
                           sample.info.9CL,
                           sample.info.9Mix)
sample.info.merge <- sample.info.merge[sample.info.merge$Pass_QC == 1,]

rm(sample.info.100, sample.info.200,
   sample.info.4CL, sample.info.9CL, sample.info.9Mix)
...
rc_Smart3_merge <- cbind(rc_Smart3_3, rc_Smart3_5, rc_Smart3_10,
                         rc_Smart3_20, rc_Smart3_50,
                         rc_Smart3_100, rc_Smart3_500, rc_Smart3_1000)
rm(rc_Smart3_3, rc_Smart3_5, rc_Smart3_10,
   rc_Smart3_20, rc_Smart3_50,
   rc_Smart3_100, rc_Smart3_500, rc_Smart3_1000)

sample.info.Smart3 <- data.frame("cell" = colnames(rc_Smart3_merge),
...
plot.data <- rbind(sample.info.Smart3[,temp], sample.info.merge[,temp])

pdf("Sensititivy.compare.pdf",5,3)
ggplot(plot.data)+
  geom_smooth(aes(x = Mapped_Reads / 1e5, y = Gene_Detected / 1000, color = Method),
