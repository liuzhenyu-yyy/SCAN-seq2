...
sample.info[sample.info$Barcode.5 %in% as.character(53:55), ]$Cell_Line <-
  "AtT20"
sample.info[sample.info$Barcode.5 %in% as.character(56:58), ]$Cell_Line <-
  "MEF"
sample.info[sample.info$Barcode.5 %in% as.character(59:61), ]$Cell_Line <-
  "3T3"
sample.info[sample.info$Barcode.5 %in% as.character(62:64), ]$Cell_Line <-
  "Hela"
sample.info[sample.info$Barcode.5 %in% as.character(65:67), ]$Cell_Line <-
  "HepG2"
sample.info[sample.info$Barcode.5 %in% as.character(68:70), ]$Cell_Line <-
  "293T"
sample.info[sample.info$Barcode.5 %in% as.character(71:73), ]$Cell_Line <-
  "H9"
sample.info[sample.info$Barcode.5 %in% as.character(74:79), ]$Cell_Line <-
  "K562"
sample.info[sample.info$Barcode.5 %in% as.character(80:82), ]$Cell_Line <-
  "GM12878"
...
ggplot() +
  geom_point(aes(
    ...
    y = log10(1 + rc_ERCC$`9CL_Bc53_Bc01`),
    color = "Bc75_Bc01"
  )) +
  geom_point(aes(
    x = log10(1 + ERCC.info$concentration_mix_1),
    y = log10(1 + rc_ERCC$`9CL_Bc53_Bc02`),
    color = "Bc75_Bc02"
  )) +
  geom_point(aes(
    x = log10(1 + ERCC.info$concentration_mix_1),
    y = log10(1 + rc_ERCC$`9CL_Bc82_Bc31`),
    color = "Bc75_Bc03"
  )) +
  geom_point(aes(
    x = log10(1 + ERCC.info$concentration_mix_1),
    y = log10(1 + rc_ERCC$`9CL_Bc82_Bc28`),
    color = "Bc75_Bc04"
  )) +
